...
export const MOON_DATA: Planet = {
  ...
  color: 'bg-slate-300',
  distanceFromSun: '150 מיליון ק"מ (הממוצע של הארץ מהשמש)',
  distanceFromEarth: '384,400 ק"מ',
  size: '3,474 ק"מ',
...
export const PLANETS: Planet[] = [
  {
    ...
    distanceFromEarth: '77-222 מיליון ק"מ',
    size: '4,879 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '38-261 מיליון ק"מ',
    size: '12,104 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '0 ק"מ (אנחנו כאן!)',
    size: '12,742 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '54.6-401 מיליון ק"מ',
    size: '6,779 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '588-968 מיליון ק"מ',
    size: '139,820 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '1.2-1.7 מיליארד ק"מ',
    size: '116,460 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '2.6-3.2 מיליארד ק"מ',
    size: '50,724 ק"מ',
  ...
  },
  {
    ...
    distanceFromEarth: '4.3-4.7 מיליארד ק"מ',
    size: '49,244 ק"מ',
...
export const DWARF_PLANETS: Planet[] = [
  {
    ...
    distanceFromEarth: '4.2-7.5 מיליארד ק"מ',
    size: '2,376 ק"מ',
  ...
  },
  {
    ...
    name: 'צרס',
    englishName: 'Ceres',
    description: 'כוכב הלכת הננסי הקרוב ביותר לשמש, נמצא בחגורת אסטרואידים בין מאדים לצדק.',
    funFact: 'צרס מהווה כרבע מהמסה הכוללת של כל חגורת האסטרואידים!',
    color: 'bg-slate-500',
    distanceFromSun: '414 מיליון ק"מ',
    distanceFromEarth: '263-607 מיליון ק"מ',
    size: '940 ק"מ',
